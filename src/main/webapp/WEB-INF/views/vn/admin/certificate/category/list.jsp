        ...
        <div class="row justify-content-center">
            <div class="col-12">
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <ul class="nav nav-tabs nav-overflow header-tabs">
                                    <li class="nav-item">
                                        <a href="/cms/certificate" class="nav-link text-nowrap active">
                                            Danh mục chứng chỉ
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/cms/certificate/detail" class="nav-link text-nowrap">
                                            Chứng chỉ
                                        </a>
                                    </li>
                                </ul>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p>Danh mục chứng chỉ cấp 1 sử dụng: <span class="fw-bold">${activeCert1}</span> / <span
                                class="fw-bold">${totalCert1}</span> danh mục</p>
                        <hr>
                        <p>Danh mục chứng chỉ cấp 2 sử dụng: <span class="fw-bold">${activeCert2}</span> / <span
                                class="fw-bold">${totalCert2}</span> danh mục</p>
                    </div>
                    <div>
                        <a href="/cms/certificate/export" class="btn btn-success mb-5"><i class="fe fe-download"></i>
                            Tải danh sách chứng chỉ
                        </a>
                        <a class="btn btn-primary mb-5" href="/cms/certificate/new"><i class="fe fe-plus-circle"></i>
                            Thêm
                            danh
                            mục
                            chứng chỉ cấp 1</a>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active">
                        <div class="card" data-list=''>
                            <form:form action="/cms/certificate" modelAttribute="catSearch" id="searchForm"
                                       method="get">
                                    ...
                                    <div class="row align-items-center col-1">
                                        ...
                                        <div class="col col-md-2">
                                            <form:select class="form-select" id="searchConditon" path="searchItem">
                                                <option value="">Tên chứng chỉ cấp 2</option>
                                            </form:select>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-sm table-hover text-center table-nowrap card-table">
                                        ...
                                        <thead>
                                        <tr>
                                            <th>Tên danh mục chứng chỉ</th>
                                            <th>Số lượng chứng chỉ</th>
                                            <th>Thứ tự</th>
                                            ...
                                            <tr>
                                                <td class="text-start">
                                                    ...
                                                    <a type="button" class="btn btn-secondary float-end"
                                                       href="/cms/certificate/cert1/new/${item.key.cert1_seq}">
                                                        Thêm danh mục chứng chỉ cấp 2
                                                    </a>
                                                </td>
                                                <td>${item.key.cert3_quantity}</td>
                                                ...
                                                <td>
                                                    <a class="btn btn-outline-primary"
                                                       href="/cms/certificate/update/cert1/category/${item.key.cert1_seq}">Chỉnh
                                                        sửa</a>
                                            ...
                                            <c:forEach items="${item.value}" var="item2">
                                                <tr>
                                                    <td class="text-start"><i
                                                        ...
                                                        <a type="button" class="btn btn-secondary float-end"
                                                           href="/cms/certificate/cert2/new/${item2.cert2_seq}">
                                                            Thêm chứng chỉ
                                                        </a>
                                                    </td>
                                                    <td></td>
                                                    <td>${item2.cert2_sort}</td>
                                                    <td>
                                                        <c:if test="${item2.cert2_display eq 'Y'}">
                                                            Có
                                                        </c:if>
                                                        <c:if test="${item2.cert2_display eq 'N'}">
                                                            <span class="text-danger">Không</span>
                                                        </c:if>
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-outline-primary"
                                                           href="/cms/certificate/cert2/update/${item2.cert2_seq}">Chỉnh
                                                            sửa</a>
                                                        <a class="btn btn-outline-danger"
                                                           onclick="return confirm('Bạn có chắc chắn muốn xóa chứng chỉ?');"
                                                           href="/cms/certificate/delete/cert2/${item2.cert2_seq}">Xóa</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </c:forEach>
